...
ActiveRecord::Schema.define(version: 20_230_521_160_920) do
  ...
  create_table 'vacation_requests', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[planning_session_id user_id], name: 'index_vacation_requests_on_planning_session_id_and_user_id', unique: true
  ...
  create_table 'vacations', force: :cascade do |t|
    ...
    t.index %w[user_id planning_session_id], name: 'index_vacations_on_user_id_and_planning_session_id', unique: true
